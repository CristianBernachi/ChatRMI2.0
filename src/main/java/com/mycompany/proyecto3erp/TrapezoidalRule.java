	 ...
	 Function<Double, Double> function;
	  ...
	  //double n = 2147483647;
        ...
        try {
              ...
              remoteCalculator.enviar(a, b, n, tipo, numThreads);
              System.out.println("Enviado");
              
              while(remoteCalculator.flag2()){}
              
              double result = remoteCalculator.resultado();

              String str = String.format("%f", result);
              resultadoLabel.setText(str);
              tiempoLabel.setText("" + (System.currentTimeMillis() - tiempo) + " mS");
              textArea.setText("El area bajo la curva de " + tipo + " en el rango [" + a + ", " + b + "] es " + str + ".\nSe realizo en: " + (System.currentTimeMillis() - tiempo) + " mS \n");
